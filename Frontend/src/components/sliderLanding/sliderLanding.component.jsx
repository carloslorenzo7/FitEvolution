    ...
    constructor(props) {
        ...
        this.state = {
            ...
            sliderDb: [["https://images.pexels.com/photos/428364/pexels-photo-428364.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1", "Javier Rodríguez Torres", `"Gracias por todo FitRevolution..."`, 'https://c0.klipartz.com/pngpicture/186/15/gratis-png-hotel-de-5-estrellas-estrella.png'],
                ['https://images.pexels.com/photos/6707077/pexels-photo-6707077.jpeg?auto=compress&cs=tinysrgb&w=600', "Ana Martínez López",`"La recomiendo al 100%, los profes muy buenos y la atencion de 10..."`,'https://c0.klipartz.com/pngpicture/186/15/gratis-png-hotel-de-5-estrellas-estrella.png'],
